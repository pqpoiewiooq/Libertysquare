(function() {
	...
	function initEvents() {
		...
		document.querySelector("#top .logo").addEventListener('click', function() { location.href = 'https://libertysquare.co.kr/'; });
		document.querySelector(".logo-mobile").addEventListener('click', function() { location.href = "https://libertysquare.co.kr/"; });
	...
	function domContentLoadedListener() {
		majax.load(document.querySelector(".content-container"), 'https://api.libertysquare.co.kr/support/main', "GET")
			.then(function(xhr) {
				...
				var dataset = [json.recommendation, json.recency, json.best];
