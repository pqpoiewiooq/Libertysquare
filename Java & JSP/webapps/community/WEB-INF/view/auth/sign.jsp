...
<head>
    <jsp:include page="/WEB-INF/view/head.jsp" flush="false">
		<jsp:param name="title" value="가입 혹은 로그인 | FLATTOP" />
	</jsp:include>
    <link rel="stylesheet" type="text/css" href="https://ls2020.cafe24.com/css/flattop/layout.css">
    <link rel="stylesheet" type="text/css" href="https://ls2020.cafe24.com/css/flattop/auth.css">
</head>
<body class="sign">
    <header>
		<a href="https://libertysquare.co.kr/" class="logo libertysquare"></a>
		<span class="logo-divider"></span>
		<a href="/" class="logo flattop"></a>
		<div class="header-desc">
			자유광장 계정을 통해
			<br>
			<strong>플랫탑</strong>과 <strong>자유광장</strong>을 함께 이용하세요!
		</div>
	</header>
...
(function() {
    ...
    document.querySelector(".form-button.sign").addEventListener('click', function(event){
        ...
        if(regex.test(inputID.value)){
            majax.checkID(inputID.value, function(result) {
                mForm.action = (result === true) ?
									"https://libertysquare.co.kr/signin" :
									"https://libertysquare.co.kr/signup?p=" + inputID.value;
                mForm.submit();
            });
        } else {
            inputID.focus();
    ...
    document.querySelector(".form-button.blue").addEventListener('click', function(event) {
        event.preventDefault();
        location.href = "https://libertysquare.co.kr/signup";
    });
}());
</script>
</html>