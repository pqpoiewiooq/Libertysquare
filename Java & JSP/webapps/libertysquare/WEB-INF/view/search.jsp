...
<head>
    <jsp:include page="/WEB-INF/view/head.jsp" flush="false">
		<jsp:param name="title" value="자유광장 | 검색" />
	</jsp:include>
...
<body>
    ...
    <div class="search-header-container">
        ...
        <div class="search-header-filter-container">
            <div class="search-filter-category-wrapper">
                <button class="search-filter-category-btn">행사 유형</button>
            </div>
            <div class="search-filter-category-wrapper">
                <button class="search-filter-category-btn">카테고리</button>
            </div>
            <div class="search-filter-category-wrapper">
                <button class="search-filter-category-btn">가격</button>
            </div>
        </div> 
    </div>
    ...
    <script type="text/javascript" src="https://ls2020.cafe24.com/js/ls/search.js"></script>
</body>
</html>