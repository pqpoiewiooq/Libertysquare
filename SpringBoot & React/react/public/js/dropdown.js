(function() {
    /**
     * @event optionselect : 옵션 선택시
     * @event optionchange : 옵션 변경시(at select same option does not dispatch)
     */
    class Dropdown {
        static count;
        static styleSheet;
        ...
        _create() {
            ...
            var style, scroll, _class, option, init, defaultValue;
            ...
            var firstOption = this.find(defaultValue || (init && 0));
            if(firstOption) {
                this._initFirstOptionSetting(firstOption);
                let initEvent = new CustomEvent("optioninit", {
                    detail: {
                        target: firstOption,
                        dropdown: this,
                        before: undefined,
                        after: {text: firstOption.textContent, value: firstOption.value}
                    }
                });
        ...
        find(what) {
            ...
            if(!this.dropdownElement.children) return;
            ...
            switch(typeof what) {
                ...
                case "number":
                    if(what < 0) return;
                    if(what >= this.dropdownElement.children.length) return;
                    return this.dropdownElement.children[what];
                default:
                    for(var i = 0; i < this.dropdownElement.children.length; i++) {
                        var op = this.dropdownElement.children[i];
                        if(op.value === what) {
                            return op;
                        }
                    }
        ...
        select(index) {
            if(typeof(index) == "number") {
                var op = this.dropdownElement.children[index];
                op.dispatchEvent(new Event("click"));
                return op;
            }
        }
        ...
        selectListener(event) {
            ...
            if(prevOption && !this.selectedOption.isSameNode(prevOption)) {
    ...
    DropdownConfigs = {
        time_half : {
            option:{
                "오전 00:00": "00:00", "오전 00:30": "00:30",
                "오전 01:00": "01:00", "오전 01:30": "01:30",
                "오전 02:00": "02:00", "오전 02:30": "02:30",
                "오전 03:00": "03:00", "오전 03:30": "03:30",
                "오전 04:00": "04:00", "오전 04:30": "04:30",
                "오전 05:00": "05:00", "오전 05:30": "05:30",
                "오전 06:00": "06:00", "오전 06:30": "06:30",
                "오전 07:00": "07:00", "오전 07:30": "07:30",
                "오전 08:00": "08:00", "오전 08:30": "08:30",
                "오전 09:00": "09:00", "오전 09:30": "09:30",
                "오전 10:00": "10:00", "오전 10:30": "10:30",
                "오전 11:00": "11:00", "오전 11:30": "11:30",

                "오후 00:00": "12:00", "오후 00:30": "12:30",
                "오후 01:00": "13:00", "오후 01:30": "13:30",
                "오후 02:00": "14:00", "오후 02:30": "14:30",
                "오후 03:00": "15:00", "오후 03:30": "15:30",
                "오후 04:00": "16:00", "오후 04:30": "16:30",
                "오후 05:00": "17:00", "오후 05:30": "17:30",
                "오후 06:00": "18:00", "오후 06:30": "18:30",
                "오후 07:00": "19:00", "오후 07:30": "19:30",
                "오후 08:00": "20:00", "오후 08:30": "20:30",
                "오후 09:00": "21:00", "오후 09:30": "21:30",
                "오후 10:00": "22:00", "오후 10:30": "22:30",
                "오후 11:00": "23:00", "오후 11:30": "23:30"
            },
            scroll: 5
        },
        category_event : {
    ...
    // Default Setting 
    setDefaultDropdownOption(DropdownConfigs.time_half.option);
})();