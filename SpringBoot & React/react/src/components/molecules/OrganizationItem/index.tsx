...
import { Img, Svg } from 'components/atoms';
...
const OrganizationItem = ({ to, name, src, subscribeCount, className } : OrganizationItemProps) => {
	return (
		<Link className={className ? `${styles.item} ${className}` : styles.item} to={to}>
